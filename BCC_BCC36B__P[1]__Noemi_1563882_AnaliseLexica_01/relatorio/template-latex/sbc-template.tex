...
Apesar de T++ ser uma linguagem simples, ela permite a execução de algoritmos complexos, como de ordenação. A seguir, está descrito o algoritmo de busca BubbleSort na linguagem t++.
